    ...
    def test_success_new_project(
        ...
        assert response.json() == {
            "current_version": {
                ...
                "git_develop_url": "git.moscow.alfaintra.net/projects/AFM/repos/feature_store_dags_prod/browse/mlops_super_feature_project/?at=refs%2Fheads%2Ftest_branch_name",
                "git_master_url": "git.moscow.alfaintra.net/projects/AFM/repos/feature_store_dags_prod/browse/mlops_super_feature_project/?at=refs%2Fheads%2Ftest_branch_name",
                "jira_task": "FSTORE-777",
